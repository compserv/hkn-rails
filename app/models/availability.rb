...
class Availability < ActiveRecord::Base
  ...
  validates :preferred_room,
    ...
    inclusion: {
      in:      Slot::Room::Valid,
      message: "should be Cory (#{Slot::Room::Cory}), Soda (#{Slot::Room::Soda}), or Online (#{Slot::Room::Online})"
    }
  ...
  def self.slider_value(availability)
  ...
  def self.slider_to_room_strength(value)
    case value
